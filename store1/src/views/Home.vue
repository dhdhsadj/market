    ...
    <main>
      ...
      <div class="toolbar">
        ...
        <div class="toolbar-buttons">
          <button class="btn-nav" @click="prevCategory" :disabled="currentPage === 1">
            <i class="arrow left"></i>
          </button>
          <button class="btn-nav" @click="nextCategory" :disabled="currentPage === totalPages">
...
export default defineComponent({
  ...
  setup() {
    ...
    const totalPages = computed(() => Math.ceil(totalCategories / itemsPerPage.value));
